        ...
        return [
            {
                ...
                "output": '{"risk_level": 4, "risk_type": "police_impersonation", "confidence": 0.95, "analysis": "典型冒充公检法诈骗。公安机关不会通过电话办案，更不会要求转账。", "suggestion": "立即挂断，拨打110核实。", "warning_message": "⚠️ 紧急！这是冒充公检法诈骗。"}'
            },
            {
                "input": "【投资理财】您好，我是XX投资平台的客服，我们有一款高收益保本理财产品，年化收益率15%，现在加入还能获得新手礼包。",
                "output": '{"risk_level": 3, "risk_type": "investment_fraud", "confidence": 0.88, "analysis": "高收益保本承诺是典型投资诈骗特征。", "suggestion": "远离此类平台。", "warning_message": "⚠️ 高风险！正规理财不承诺保本。"}'
            },
            {
                "input": "【正常交流】妈，今天我不回家吃饭了，公司加班。你和爸注意身体。",
                "output": '{"risk_level": 0, "risk_type": "normal", "confidence": 0.99, "analysis": "普通家庭问候，无风险特征。", "suggestion": "正常交流。", "warning_message": ""}'
            },
            {
                "input": "【兼职刷单】好消息！足不出户，日赚300-500元！只需手机点赞、收藏、加关注，一单一结，感兴趣请加群。",
                "output": '{"risk_level": 3, "risk_type": "part_time_fraud", "confidence": 0.92, "analysis": "典型刷单诈骗话术，高佣金诱惑。", "suggestion": "刷单违法，拒绝参与。", "warning_message": "⚠️ 高风险！刷单诈骗，前期小利后期大亏。"}'
            },
            {
                "input": "【杀猪盘】亲爱的，我发现了一个赚钱的好机会，跟着导师下注，保证稳赚不赔，我已经赚了好几万了，你要不要一起？",
                "output": '{"risk_level": 3, "risk_type": "pig_butchery", "confidence": 0.90, "analysis": "杀猪盘话术，以感情铺垫诱导投资。", "suggestion": "网络交友涉及金钱务必警惕。", "warning_message": "⚠️ 高风险！疑似杀猪盘，勿轻信网络投资。"}'
            }
        ]
